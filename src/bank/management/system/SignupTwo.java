...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
        ...
        String incomelcategory[] = {"Null", "< 1,10,000","< 2, 30,000","< 3 50,000","< Upto 50,000"};
        income = new JComboBox(incomelcategory);
        ...
        String educationValues[] = {"Non-Graduation", "< Graduate","Post-Graduation","Doctpr","Others"};
